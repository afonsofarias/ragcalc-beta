export const c_top = [
    ...
    {
        id: '310008', dbname: 'Highpriest_Top2', name: '(kRO) High Priest Stone II(Upper)',
        tags: 'ARCHBISHOP',
        script: function () {
    ...
    {
        id: '311356', dbname: 'Archbishop_Top3', name: '(kRO) Archbishop Stone (Upper)',
        tags: 'ARCHBISHOP',
        script: function () {
...
export const c_mid = [
    ...
    {
        id: '310009', dbname: 'Highpriest_Middle2', name: '(kRO) High Priest Stone II(Middle)',
        tags: 'ARCHBISHOP',
        script: function () {
    ...
    {
        id: '311357', dbname: 'Archbishop_Middle3', name: '(kRO) Archbishop Stone (Middle)',
        tags: 'ARCHBISHOP',
        script: function () {
...
export const c_low = [
    ...
    {
        id: '310010', dbname: 'Highpriest_Bottom2', name: '(kRO) High Priest Stone II(Lower)',
        tags: 'ARCHBISHOP',
        script: function () {
            equipStats.VCT += 5;
        }
    ...
    {
        id: '311358', dbname: 'Archbishop_Bottom3', name: '(kRO) Archbishop Stone (Lower)',
        tags: 'ARCHBISHOP',
        script: function () {
