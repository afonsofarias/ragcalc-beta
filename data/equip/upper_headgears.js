...
export const tops = [
    ...
    },
    {
        ...
        script: function () {
            ...
            equipStats.dex += 1;
            equipStats.luk += 1;
            // Recarga de [Meteoro Escarlate] -1 segundo.
            // Adicionar
            // A cada refino: Dano mágico +1%.
            multipliers.matk += refinement.top;
            // A cada refino: Recarga de [Meteoro Escarlate] -0,1 segundos.
            // Adicionar
            // A cada 2 refinos: Dano de [Impacto Espiritual] +5%.
